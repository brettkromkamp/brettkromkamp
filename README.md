...
I am currently working on a [Flutter](https://flutter.dev/)-based cross-platform note-taking and (personal) knowledge management application. Note-taking and knowledge management is a [crowded space](https://github.com/brettkromkamp/awesome-knowledge-management). My contribution, however, to this plethora of approaches and applications in this space is based on [topic maps](https://ontopia.net/topicmaps/materials/tao.html) and [Contextualise](https://contextualise.dev/), respectively.
