...
I contribute to and maintain [Contextualise](https://github.com/brettkromkamp/contextualise), [TopicDB](https://github.com/brettkromkamp/topic-db) and a couple of other open source projects. Expect many of my projects to be related to building educational tools with semantic technologies and web-based 3D using Python, JavaScript and Blender.
